...
const REQUIRED_PACKAGES = {
  dependencies: ["@code-updater/react-native"],
  devDependencies: ["dotenv", "code-updater"],
};

const PACKAGE_MAP = {
  supabase: {
    dependencies: [],
    devDependencies: ["@code-updater/supabase"],
  },
  aws: {
    dependencies: [],
    devDependencies: ["@code-updater/aws"],
  },
  "cloudflare-d1-r2-worker": {
    dependencies: [],
    devDependencies: ["wrangler", "@code-updater/cloudflare"],
  },
} as const;
    ...
    options: [
      {
        value: {
          dependencies: [],
          devDependencies: ["@code-updater/metro"],
        },
        label: "Metro",
      },
    ],
