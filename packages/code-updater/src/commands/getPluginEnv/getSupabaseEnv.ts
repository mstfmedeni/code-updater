...
CODE_UPDATER_SUPABASE_URL=%%CODE_UPDATER_SUPABASE_URL%%
CODE_UPDATER_SUPABASE_ANON_KEY=%%CODE_UPDATER_SUPABASE_ANON_KEY%%
CODE_UPDATER_SUPABASE_BUCKET_NAME=%%CODE_UPDATER_SUPABASE_BUCKET_NAME%%
`;
